...
class LectureItemTeacherProfile extends StatefulWidget {
  const LectureItemTeacherProfile({
  ...
  @override
  State<LectureItemTeacherProfile> createState() => _LectureItemTeacherProfileState();
}

class _LectureItemTeacherProfileState extends State<LectureItemTeacherProfile> {
